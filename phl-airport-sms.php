...
function getFlightInfo($flight_num, $date) {
	
	
	$query = str_replace(array("[[flight_num]]", "[[date]]", array($flight_num, $date), SCRAPERWIKI_QUERY);
...
function formatResponse($flight_info, $channel) {
